...
if __name__ == "__main__":
    ...
    # python3 app.py "https://youtu.be/ZLXHyOIIM0o" --service "openai-srt" --path "./incoming"  --prompt "My name is Travis Frisinger. I am a software engineer who blogs, streams and pod cast about my AI Adventures with Gen AI." 
